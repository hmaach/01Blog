...
import com.blog.modules.post.domain.port.in.ProductService;
...
import com.blog.modules.post.infrastructure.adapter.out.persistence.ProductRepositoryImpl;
...
public class ProductDomainService implements ProductService {
    ...
    public ProductDomainService(ProductRepositoryImpl productRepository, UserRepositoryImpl userRepository) {
